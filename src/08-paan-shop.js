...
export function createPaanOrder(basePaan, customizations) {
  ...
  if(typeof customizations !== "object") return structuredClone(basePaan);
...
export function updatePrices(menu, increase) {
  // Your code here
  if(menu===null || typeof menu !== "object" || typeof increase !== "number" ) return {};

  return Object.fromEntries(Object.entries(menu).map(
    ([item,price])=>{
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  ...
  if(typeof regularMenu !== "object")
      regularMenu = {};
  if(typeof specialsMenu !== "object") 
      specialsMenu = {};

  const dailySpecial = {...regularMenu, ...specialsMenu};
  return dailySpecial;
}
